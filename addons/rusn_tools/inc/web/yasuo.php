...
class PHPZip
{
  ...
  public function Zip($dir, $saveName)
  {
    ...
    $this->addFile("open this url: http://wxapp.we7.in \r\n or jion us goto:http://www.we7.in", 'get_more_wxapp.txt');
    $this->addFile("打开这个网址: http://wxapp.we7.in \r\n 或者加入我们:http://www.we7.in", '获得更多小程序.txt');
    foreach($filelist as $file)
    {
